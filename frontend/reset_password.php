...
<head>
    ...
    <title>Restablecer Contraseña - La Vicky</title>
    <!-- Bootstrap 5.3 -->
                ...
                <div class="login-card position-relative animate-fade-in">
                    ...
                    <div class="card-body p-5">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted small">Crea una nueva contraseña para acceder a tu cuenta.</p>
                        </div>
                        
                        <div id="successMsg" class="alert alert-success shadow-sm py-2 px-3 small mb-4" style="display: none;">
                            <i class="fas fa-check-circle me-2"></i> Contraseña actualizada. <br><br>
                        ...
                        <form id="resetForm">
                            ...
                            <div class="mb-3">
                                <label for="password" class="form-label fw-semibold small text-uppercase text-muted mb-0">Nueva Contraseña</label>
                            ...
                            <div class="mb-4">
                                <label for="confirm_password" class="form-label fw-semibold small text-uppercase text-muted mb-0">Confirmar Contraseña</label>
                                <div class="input-group mt-2">
                                    <span class="input-group-text text-muted"><i class="fas fa-lock"></i></span>
                                    <input type="password" id="confirm_password" class="form-control" required placeholder="******" minlength="6">
                                </div>
                            </div>
    ...
    <script>
        ...
        document.getElementById('resetForm').addEventListener('submit', function(e) {
            ...
            if (password !== confirm_password) {
                showToast('Error', 'Las contraseñas no coinciden.', 'bg-danger');
                return;
            }
            if (password.length < 6) {
                showToast('Error', 'La contraseña debe tener al menos 6 caracteres.', 'bg-danger');
                return;
            }
            ...
            fetch('../backend/api.php?route=reset_password', {
                method: 'POST',
                body: formData
            })
