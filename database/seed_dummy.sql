...
-- GASTOS (20 registros)
-- =============================================================
INSERT INTO gastos (id, descripcion, monto, fecha, categoria, eliminado) VALUES
(1,  'Pago de electricidad Agosto',        150.00, '2026-08-01 08:00:00', 'servicios',     0),
(2,  'Compra de combustible generador',     45.00, '2026-08-01 14:00:00', 'combustible',   0),
(3,  'Mantenimiento horno industrial',     200.00, '2026-08-02 09:00:00', 'mantenimiento', 0),
(4,  'Compra de limpieza general',          35.00, '2026-08-02 15:00:00', 'limpieza',      0),
(5,  'Pago agua potable Julio',             28.00, '2026-08-03 08:00:00', 'servicios',     0),
(6,  'Reparación amasadora',               350.00, '2026-08-03 10:00:00', 'mantenimiento', 0),
...
-- =============================================================
INSERT INTO ventas (id, pedido_id, subtotal, impuestos, descuento, total, monto_pagado, cambio, tipo_pago, ganancias, usuario_id, estado, fecha_venta) VALUES
(1,  1,  10.87, 1.63, 0.00, 12.50, 12.50, 0.00, 'efectivo',      7.50, 1, 'completado', '2026-08-01 08:00:00'),
(2,  2,   7.61, 1.14, 0.00,  8.75,  8.75, 0.00, 'efectivo',      5.75, 1, 'completado', '2026-08-01 09:30:00'),
(3,  3,  21.74, 3.26, 0.00, 25.00, 25.00, 0.00, 'tarjeta',      14.00, 2, 'completado', '2026-08-02 07:00:00'),
(4,  4,  13.30, 2.00, 0.00, 15.30, 15.30, 0.00, 'efectivo',      8.16, 2, 'completado', '2026-08-02 10:00:00'),
(5,  5,  27.83, 4.17, 0.00, 32.00, 32.00, 0.00, 'transferencia', 22.40, 1, 'completado', '2026-08-03 08:30:00'),
(6,  6,   5.65, 0.85, 0.00,  6.50,  6.50, 0.00, 'efectivo',      3.90, 1, 'completado', '2026-08-03 11:00:00'),
(7,  7,  16.30, 2.45, 0.00, 18.75, 18.75, 0.00, 'tarjeta',      11.25, 2, 'completado', '2026-08-04 07:30:00'),
(8,  8,   8.87, 1.33, 0.00, 10.20, 10.20, 0.00, 'efectivo',      5.44, 2, 'completado', '2026-08-04 09:00:00'),
(9,  9,  19.48, 2.92, 0.00, 22.40, 22.40, 0.00, 'wallet',       12.32, 1, 'completado', '2026-08-05 08:00:00'),
(10, 10, 12.70, 1.90, 0.00, 14.60, 14.60, 0.00, 'efectivo',      7.92, 1, 'completado', '2026-08-05 10:30:00'),
(11, 11, 25.13, 3.77, 0.00, 28.90, 28.90, 0.00, 'wallet',       15.68, 2, 'completado', '2026-08-06 07:00:00'),
(12, 12,  8.52, 1.28, 0.00,  9.80,  9.80, 0.00, 'efectivo',      5.32, 2, 'completado', '2026-08-06 11:30:00'),
(13, 13, 14.35, 2.15, 0.00, 16.50, 16.50, 0.00, 'tarjeta',       9.24, 1, 'completado', '2026-08-07 08:00:00'),
(14, 14, 17.39, 2.61, 0.00, 20.00, 20.00, 0.00, 'efectivo',     14.00, 1, 'completado', '2026-08-07 09:30:00'),
(15, 15,  9.78, 1.47, 0.00, 11.25, 11.25, 0.00, 'wallet',        6.75, 2, 'completado', '2026-08-08 07:00:00'),
(16, 16, 30.43, 4.57, 0.00, 35.00, 35.00, 0.00, 'transferencia', 24.50, 2, 'completado', '2026-08-08 10:00:00'),
(17, 17,  6.78, 1.02, 0.00,  7.80,  7.80, 0.00, 'efectivo',      4.68, 1, 'completado', '2026-08-09 08:30:00'),
(18, 18, 17.04, 2.56, 0.00, 19.60, 19.60, 0.00, 'tarjeta',      10.78, 1, 'completado', '2026-08-09 11:00:00'),
(19, 19, 11.65, 1.75, 0.00, 13.40, 13.40, 0.00, 'wallet',        7.28, 2, 'completado', '2026-08-10 07:30:00'),
